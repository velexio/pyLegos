...
class ControllerResponse:
    ...
    def __init__(self, responseBody='', respondFail=False, faileCode=-100, failMessage='FAIL'):
        if respondFail:
            statusCode = faileCode
...
class App(metaclass=Singleton):
    ...
    def injectModule(self):
        modName = Inspector.getCallerMod()
        fps = PlatformProperty.FileSep
        ...
        modVersion = literal_eval(verConfigManager.getValue(sectionName='VERSION_INFO',
