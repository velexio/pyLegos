...
class ProjectService:
    ...
    def __buildManifest(self):
        ...
        targetFile = self.ProjectBaseDir+self.ProjectName.lower()+'_manifest.ini'
...
class ModuleService:
    ...
    def __buildCodeFiles(self):
        ...
        for tpl in templateFiles:
            FileUtils.copyFile(self.TemplateDir+tpl, self.ModuleDir+tpl.replace('module', self.ModuleName).replace('.tpl', '.py'))
